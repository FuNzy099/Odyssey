 ...
 */
final class Version20221016090948 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE participation (id INT AUTO_INCREMENT NOT NULL, sender_id INT NOT NULL, recipient_id INT NOT NULL, conversation_id INT NOT NULL, INDEX IDX_AB55E24FF624B39D (sender_id), INDEX IDX_AB55E24FE92F8F78 (recipient_id), INDEX IDX_AB55E24F9AC0396 (conversation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE participation ADD CONSTRAINT FK_AB55E24FF624B39D FOREIGN KEY (sender_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE participation ADD CONSTRAINT FK_AB55E24FE92F8F78 FOREIGN KEY (recipient_id) REFERENCES `user` (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participation DROP FOREIGN KEY FK_AB55E24FF624B39D');
        $this->addSql('ALTER TABLE participation DROP FOREIGN KEY FK_AB55E24FE92F8F78');
